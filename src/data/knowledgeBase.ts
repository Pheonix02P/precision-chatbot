...
- Roman numerals (I, II, IV, etc.) are NOT permitted due to SEO impact`,
  ...
  },
  {
    ...
    keywords: ["project description", "about project", "description types", "system generated description", "user generated description", "change description", "types of descriptions", "types of project descriptions"],
    content: `## What Types of Descriptions/About Project Can Be Used on an XID Page & How to Change Them?

There are two types of descriptions available on an XID page:
...
- The content for user-generated descriptions can be taken from the project brochure or official website, with minor modifications to avoid negative SEO impact
...
Only in exceptional circumstances, such as legal issues etc, the project page can be deactivated/deleted.
...
**For RERA-Registered Projects:**
- Project is deactivated as builder request. Builder communication must be shared for reactivation
- The project may be deactivated if the RERA registration has lapsed
- To reactivate:
  - Share the new RERA number, OR
  - Provide the RERA extension certificate
  - If project is Ready to move, share OC/CC`,
