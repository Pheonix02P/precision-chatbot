...
const QUERY_MAPPINGS: Record<string, string> = {
  ...
  "unable to active": "slot activation error unable to activate slots AS present NAN price",
  "unable to activate": "slot activation error unable to activate slots AS present NAN price",
  "activation error": "slot activation error unable to activate slots error occurred",
  "slot error": "slot activation error unable to activate slots error occurred",
  ...
  "raw video": "raw video footage policy self video upload CRM consent form",
  "raw video upload": "self video upload CRM consent form raw video sales person client",
  "sales person upload video": "self video upload CRM consent form raw video client",
  "client raw video": "self video upload CRM consent form raw video sales person",
  "self video upload": "self video upload CRM consent form raw video",
  ...
  try {
    ...
    for (const model of GEMINI_MODELS) {
      try {
        ...
        console.error(`Gemini ${model} error:`, aiResp.status, errText);
        aiResp = null;
      } catch (err) {
